...
@Module({ imports: [ConfigModule.forRoot({ isGlobal: true }), AppConfigModule, DatabaseModule, HealthModule, AuthModule, UsersModule, RolesModule, MenusModule, DeptsModule, PostsModule, DictTypesModule, DictDataModule, ConfigsModule, LoginLogsModule, OperationLogsModule], providers: [{ provide: APP_GUARD, useClass: AccessTokenGuard }, { provide: APP_INTERCEPTOR, useClass: OperationLogInterceptor }] })
